 ...
 */
@Data
public class DataTreeSelect implements Serializable
{
    ...
    private List<DataTreeSelect> children;

    public DataTreeSelect()
    {

    }

    public DataTreeSelect(CollectorInfo collectorInfo)
    {
